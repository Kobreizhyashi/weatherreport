        ...
        return LazyColumn(
            ...
            item {
                Row(Modifier.background(MaterialTheme.colors.secondary)) {
                    TableCell(text = getString(R.string.city_name), weight = Constants.CELL_WIDTH, textColor = Color.White)
                    TableCell(
                        text = getString(R.string.city_temperature),
                        weight = Constants.CELL_WIDTH,
                        textColor = Color.White
                    )
                    TableCell(text = getString(R.string.city_clouds), weight = Constants.CELL_WIDTH, textColor = Color.White)
                }
            }
            ...
            items(weatherReport.mapIndexed { index, item ->
                ...
                Row(
                    ...
                    TableCell(text = it.second.main.temp.toString() + Constants.CELCIUS, weight = Constants.CELL_WIDTH)
